import requests
import allure
from date.variables import data_without_required_field
from date.urls import creating_user


class TestCreatingUser:

    @allure.title('Создание уникального пользователя')
    def test_creating_unique_user(self, random_user_data):
    ...
    def test_creating_registered_user(self, payload_registered_user):
